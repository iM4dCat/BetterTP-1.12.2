...
public class CommandSetForwardVelocity extends CommandBase {
    public CommandSetForwardVelocity() {
    }

    public String getName() {
        return "setforwardvelocity";
    }
    ...
    public String getUsage(ICommandSender p_71518_1_) {
        return "/setforwardvelocity <entity> <x> <y> <z>";
    }
